...
Verification checks integrity, media shape, outside-region preservation, and owned-region equality in that order. The owned-region oracle is the donor except at declared Exact Copy positions, where the hash-locked Exact Copy RGBA is authoritative. A raw generated donor cannot become a Verified Candidate when Assembly is required; its hash identity and assembled pixels are proved without a caller-provided kind label. Verification returns the canonical Assembly report with its evidence and classification but never writes the Run Record or records subjective Approval.
