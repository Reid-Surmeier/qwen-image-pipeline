...
| inherited-qwen-openrouter-kernel | qwen_ui_pipeline/qwen_adapter.py | retained implementation | tests/test_qwen_adapter.py proves closed protocol input, exact model/count/references, success, rejection, and count mismatch. |
